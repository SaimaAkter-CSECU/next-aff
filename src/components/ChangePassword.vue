                ...
                >
                    ...
                    >
                        <v-col
                            ...
                            md="2"
                        >
                            <v-card-text class="fs-6 fw-normal text-right pt-0 ps-0">Current Password</v-card-text>
                        </v-col>
                        <v-col
                            cols="12"
                            sm="6"
                    ...
                    >
                        <v-col
                            ...
                            md="2"
                        >
                            <v-card-text class="fs-6 fw-normal text-right pt-0 ps-0">New Password</v-card-text>
                        </v-col>
                        <v-col
                            cols="12"
                            sm="6"
                    ...
                    >
                        <v-col
                            ...
                            md="2"
                        >
                            <v-card-text class="fs-6 fw-normal text-right pt-0 ps-0">Confirm Password</v-card-text>
                        </v-col>
                        <v-col
                            cols="12"
                            sm="6"
