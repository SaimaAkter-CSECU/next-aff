    ...
    <div id="payments">
        <v-container>
            ...
            >
                ...
                >
                    <v-card-title class="card-title p-0 mb-5">
                        <div class="d-flex justify-content-between w-100 px-5">
                            <span class="fw-bold fs-5">Affiliate Information</span>
                    ...
                    <v-card-text class="text-dark" v-if="affiliateInfo">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 py-0">
                                ...
                                <v-card-text class="ps-1">{{name}}</v-card-text>
                            </div>
                            <div class="col-md-4 col-sm-12 py-0">
                                <v-card-title class="p-1 pb-1 fs-6">Contact Persor</v-card-title>
                                <v-card-text class="ps-1">{{contact_person}}</v-card-text>
                            </div>
                            <div class="col-md-4 col-sm-12 py-0">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 py-0">
                                ...
                                <v-card-text class="ps-1">{{platform_type}}</v-card-text>
                            </div>
                            <div class="col-md-4 col-sm-12 py-0">
                                <v-card-title class="p-1 pb-1 fs-6">Platform Name</v-card-title>
                                <v-card-text class="ps-1">{{platform_name}}</v-card-text>
                            </div>
                            <div class="col-md-4 col-sm-12 py-0">
                                <v-card-title class="p-1 pb-1 fs-6">Platform Link</v-card-title>
                                <v-card-text class="ps-1">{{platform_link}}</v-card-text>
                            </div>
                        </div>
                        <v-divider class="my-4"></v-divider>
                        <div class="row">
                            <div class="col-md-4 col-sm-12 py-0">
                                ...
                                <v-card-text class="ps-1">{{bkash}}</v-card-text>
                            </div>
                            <div class="col-md-4 col-sm-12 py-0">
                                <v-card-title class="p-1 pb-1 fs-6">Bank Details</v-card-title>
                                <v-card-text class="ps-1">{{bank_details}}</v-card-text>
                            </div>
                ...
                >
                    <v-card class="card px-3 py-2">
                        <v-container class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <div class="fs-2 fw-bolder text-dark">{{total_due}}/- </div>
                                <div class="fw-thin">Total Due</div>
                            </div>
                        </v-container>
                    </v-card>
                </v-col>
                ...
                >
                    <v-card class="card px-3 py-2">
                        <v-container class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <div class="fs-2 fw-bolder text-dark">{{total_received}}/- </div>
                                <div class="fw-thin">Total Received</div>
                            </div>
                        </v-container>
                    </v-card>
                </v-col>
            ...
            <v-row class="m-0 mt-6">
                ...
                >
                    <v-card class="card px-3 py-2">
                        <v-container class="d-flex align-items-center">
                            <v-simple-table class="w-100" rounded-pill>
